...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  double t1 = (measurement_pack.timestamp_ - previous_timestamp_) / 1000000.0;
  previous_timestamp_ = measurement_pack.timestamp_;
  double t2 = t1 * t1;
  double t3 = t1 * t2;
  double t4 = t1 * t3;
  double variance_ax = 9;
  double variance_ay = 9;
  
  ekf_.Q_ = MatrixXd(4, 4);
  ekf_.Q_ << t4 / 4 * variance_ax, 0, t3 / 2 * variance_ax, 0,
            0, t4 / 4 * variance_ay, 0, t3 / 2 * variance_ay,
            t3 / 2 * variance_ax, 0, t2* variance_ax, 0,
            0, t3 / 2 * variance_ay, 0, t2* variance_ay;
